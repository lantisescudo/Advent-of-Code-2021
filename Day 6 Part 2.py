...
for i in range(256):
    temp = []
    for j in range(len(fishcount)-1):
        temp.append(fishcount[j+1])
    temp.append(fishcount[0])
    temp[6] = temp[6]+fishcount[0]
    fishcount = temp

    print("Count:",i,"Num:",sum(fishcount),"Counts:",fishcount)
